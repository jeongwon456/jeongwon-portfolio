...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  font-size:15px; font-weight:bold; padding:0 5px; font-family: sans-serif; }
...
<script>
  $(function () {
    ...
    $('.btn-reset').click(function () {
      ...
      firstBox.find('.filter-btn').removeClass('active').eq(3).addClass('active'); // 초등
...
<div id="cont">
  ...
  <div id="gal1">
    <div class="book">
      <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page31">
        <div class="ima"><img src="img/3/31.jpg" alt=""></div>
        <h2>수능 기출 올픽 최신 기출 단독판 확률과 통계(2026 수능 대비)</h2>
        <p>수학</p>
      </a>
    </div>
    <div class="book">
      <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page32">
        <div class="ima"><img src="img/3/32.jpg" alt=""></div>
        <h2>수능 기출 올픽 최신 기출 단독판 미적분(2026 수능 대비)</h2>
        <p>수학</p>
      </a>
    </div>
    <div class="book">
      <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page33">
        <div class="ima"><img src="img/3/33.jpg" alt=""></div>
        <h2>수능 기출 올픽 최신 기출 단독판 수학2(2026 수능 대비)</h2>
        <p>수학</p>
      </a>
    </div>
    <div class="book">
      <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page34">
        <div class="ima"><img src="img/3/34.jpg" alt=""></div>
        <h2>수능 기출 올픽 최신 기출 단독판 수학1(2026 수능 대비)</h2>
        <p>수학</p>
      </a>
    </div>
    <div class="book">
      <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page35">
        <div class="ima"><img src="img/3/35.jpg" alt=""></div>
        <h2>구해영 중학 영어 독해 Level 2</h2>
        <p>영어</p>
      </a>
    </div>
    <div class="book">
      <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page36">
        <div class="ima"><img src="img/3/36.jpg" alt=""></div>
        <h2>수능 기출 올픽 최신 기출 단독판 영어 독해(2026 수능 대비)</h2>
        <p>영어</p>
      </a>
    </div>
    <div class="book">
      <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page37">
        <div class="ima"><img src="img/3/37.jpg" alt=""></div>
        <h2>완쏠 개념 대수 (2026년)</h2>
        <p>수학</p>
      </a>
    </div>
    <div class="book">
      <a href="https://jjoo545.dothome.co.kr/g5/bbs/board.php?bo_table=page38">
        <div class="ima"><img src="img/3/38.jpg" alt=""></div>
